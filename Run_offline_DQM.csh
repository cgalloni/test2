...
if($#argv > 1) then
    ...
    echo " cd ../../../DQM/SiPixelMonitorClient/test"
   ...
   ## cd ../../SiPixelCommon/test
    cd ../../../CalibTracker/SiPixelGainCalibration/test2
    echo " cd ../../../CalibTracker/SiPixelGainCalibration/test2"
else
    set opt_flag = "false"
...
if ( $opt_flag == "true" ) then
	...
	sed "s#sFILENAME#$filetorun#" < client_template_physics_cfg.py > Run_offline_DQM_${file_counter}_cfg.py
	else if ($calib_flag == "true" ) then

	sed "s#sFILENAME#$filetorun#" < client_template_calib_cfg.py > Run_offline_DQM_${file_counter}_cfg.py
	else
	sed "s#sFILENAME#$filetorun#" < client_template_cfg.py > Run_offline_DQM_${file_counter}_cfg.py
	endif
	
	if( $all_flag == "true" ) then
	    rm Run_offline_DQM_${file_counter}_cfg.py
	sed "s#sFILENAME#$filetorun#" < client_template_all_cfg.py > Run_offline_DQM_${file_counter}_cfg.py
